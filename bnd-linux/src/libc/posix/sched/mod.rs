...
pub const _BITS_CPU_SET_H: i32 = 1;
pub const _BITS_SCHED_H: i32 = 1;
pub const _BITS_TYPES_STRUCT_SCHED_PARAM: i32 = 1;
pub const _SCHED_H: i32 = 1;
pub const __CPU_SETSIZE: i32 = 1024;
