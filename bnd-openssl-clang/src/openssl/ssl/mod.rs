...
#[cfg(feature = "types")]
windows_link::link!("ssl" "C" fn PEM_read_SSL_SESSION(out : *mut bnd_linux_clang::libc::file::FILE, x : *mut *mut SSL_SESSION, cb : super::types::pem_password_cb, u : *mut core::ffi::c_void) -> *mut SSL_SESSION);
#[cfg(feature = "types")]
...
windows_link::link!("ssl" "C" fn PEM_write_SSL_SESSION(out : *mut bnd_linux_clang::libc::file::FILE, x : *const SSL_SESSION) -> i32);
#[cfg(feature = "types")]
...
#[cfg(feature = "types")]
windows_link::link!("ssl" "C" fn SSL_CTX_flush_sessions_ex(ctx : *mut super::types::SSL_CTX, tm : bnd_linux_clang::libc::time_t::time_t));
#[cfg(feature = "types")]
...
windows_link::link!("ssl" "C" fn SSL_SESSION_get_time_ex(s : *const SSL_SESSION) -> bnd_linux_clang::libc::time_t::time_t);
...
windows_link::link!("ssl" "C" fn SSL_SESSION_print_fp(fp : *mut bnd_linux_clang::libc::file::FILE, ses : *const SSL_SESSION) -> i32);
#[cfg(feature = "types")]
...
windows_link::link!("ssl" "C" fn SSL_SESSION_set_time_ex(s : *mut SSL_SESSION, t : bnd_linux_clang::libc::time_t::time_t) -> bnd_linux_clang::libc::time_t::time_t);
...
#[cfg(feature = "types")]
windows_link::link!("ssl" "C" fn SSL_get_event_timeout(s : *mut super::types::SSL, tv : *mut bnd_linux_clang::libc::struct_timeval::timeval, is_infinite : *mut i32) -> i32);
#[cfg(feature = "types")]
...
#[cfg(all(feature = "bio", feature = "types"))]
windows_link::link!("ssl" "C" fn SSL_poll(items : *mut SSL_POLL_ITEM, num_items : usize, stride : usize, timeout : *const bnd_linux_clang::libc::struct_timeval::timeval, flags : u64, result_count : *mut usize) -> i32);
#[cfg(feature = "types")]
...
#[cfg(feature = "types")]
windows_link::link!("ssl" "C" fn SSL_sendfile(s : *mut super::types::SSL, fd : i32, offset : bnd_linux_clang::libc::types::off_t, size : usize, flags : i32) -> bnd_linux_clang::libc::types::ssize_t);
#[cfg(feature = "types")]
